      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 bg-white dark:bg-gray-800">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">
            Why Choose KT Computer Supply in Rwanda?
          </h2>
          <p className="text-lg text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
            Your trusted partner for premium electronics and computer solutions across Rwanda. Get the best devices with competitive prices from KT Computer Supply. We combine quality products, expert service, and competitive pricing to deliver exceptional value to customers throughout Rwanda.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
          <div className="text-center">
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">Premium Brands</h3>
            <p className="text-gray-600 dark:text-gray-400">
              We carry products from leading global brands including Apple, Dell, HP, Lenovo, Samsung, Sony, and more. All products are genuine with full manufacturer warranty.
            </p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Reliable delivery across all locations in Rwanda. Most orders in Kigali are delivered within 24 hours, with nationwide delivery completed within 1-3 business days.
            </p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Our technical team provides free setup, configuration, and ongoing support for all products. We're here to ensure your technology works perfectly for your needs.
            </p>
          </div>
        </div>
        ...
        <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-8">
          <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4 text-center">
            Shop with Confidence in Rwanda
          </h3>
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              <h4 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Payment Options</h4>
              <ul className="text-gray-600 dark:text-gray-400 space-y-1">
                <li>• Mobile Money (MTN Mobile Money, Airtel Money)</li>
                <li>• Bank transfers and card payments</li>
                <li>• PayPack integration for secure transactions</li>
                <li>• Cash on delivery available</li>
              </ul>
            </div>
            <div>
              <h4 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Our Commitment</h4>
              <ul className="text-gray-600 dark:text-gray-400 space-y-1">
                <li>• 30-day return policy on all products</li>
