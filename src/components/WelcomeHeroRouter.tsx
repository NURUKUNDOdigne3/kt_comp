...
import { Truck, Shield, HeadphonesIcon, Award, BarChart } from "lucide-react";
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
          ...
          <div className="space-y-6">
            ...
            >
              <span className="text-blue-600 dark:text-blue-500">BOOST</span>{" "}
              YOUR CONNECTION
            </h1>
            ...
            >
              Upgrade your internet experience with our top-quality WiFi access
              points and routers. Enjoy guaranteed extremely high performance.
            </p>
          ...
          >
            <div className="relative w-full max-w-lg">
              ...
              <div className="aspect-[4/3] bg-gradient-to-br from-white to-blue-50 dark:from-gray-800 dark:to-gray-700 rounded-2xl flex items-center justify-center overflow-hidden">
                <Image
                  src="https://wirelessmaxx.de/cdn/shop/files/STARLINKGEN2-Mesh-Router.webp?v=1744809829"
                  alt="Product Image"
                  width={500}
                  height={500}
