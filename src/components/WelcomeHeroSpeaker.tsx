...
import { Truck, Shield, Award, Volume2 } from "lucide-react";
import Image from "next/image";

gsap.registerPlugin(ScrollTrigger);

export default function WelcomeHeroRouter() {
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
          ...
          <div className="space-y-6">
            ...
            >
              <span className="text-blue-600 dark:text-blue-500">AMPLIFY</span>{" "}
              YOUR SOUND
            </h1>
            ...
            >
              Discover premium speakers that deliver powerful, crystal-clear
              audio. Guaranteed quality, and safe packaging.
            </p>
          ...
          >
            <div className="relative w-full max-w-lg">
              ...
              <div className="aspect-[4/3] bg-gradient-to-br from-white to-blue-50 dark:from-gray-800 dark:to-gray-700 rounded-2xl flex items-center justify-center overflow-hidden">
                <Image
                  src="https://www.techhive.com/wp-content/uploads/2024/03/jbl-boombox-angled-100894505-orig-2.jpg?quality=50&strip=all&w=1024"
                  alt="Product Image"
                  width={500}
                  height={500}
