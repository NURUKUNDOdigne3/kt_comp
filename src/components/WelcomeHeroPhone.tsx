...
function IPhone() {
  ...
  const { scene } = useGLTF("/models/phones/scene.gltf");
...
export default function WelcomeHeroPhone() {
    ...
    <section id="welcome-hero" className="h-screen w-full relative">
      ...
      >
        <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-4 text-gray-900">
          Experience Innovation in Your Hands
        </h1>
        <p className="text-base sm:text-lg md:text-xl text-gray-600 max-w-2xl mx-auto">
          Premium smartphones from the world's leading brands—designed for
